---
title: "Guidelines for preparing data for a gene expression meta-analysis"
author: "Jake Hughey"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Guidelines for preparing data for a gene expression meta-analysis}
...
This vignette describes the guidelines for preparing data and metadata for a gene expression meta-analysis according to the method of [Hughey and Butte (2015)](http://nar.oxfordjournals.org/content/43/12/e79.full).

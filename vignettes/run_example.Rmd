...
This vignette goes through an example of a gene expression meta-analysis according to the method of [Hughey and Butte (2015)](http://nar.oxfordjournals.org/content/43/12/e79.full). Before running this meta-analysis, you'll need to download the data and install the custom cdf packages as described [here](prepare_example.html). Running this meta-analysis for the first time requires an internet connection, as some SOFT files must be fetched from GEO.

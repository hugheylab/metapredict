...
Before running the meta-analysis, you'll need to download the data and install the custom cdf packages as described at `vignette('prepare_example', package = 'metapredict'))`.
...
```{r, fig.width = 5, fig.height = 4, fig.retina = 4}
...
```{r, fig.width = 4, fig.height = 4.5, fig.retina = 4}
...
```{r, fig.width = 7, fig.height = 4, fig.retina = 4}
...
```{r, fig.width = 7, fig.height = 3, fig.retina = 4}

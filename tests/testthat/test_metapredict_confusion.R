...
test_that('calcConfusionValidation each = TRUE', {
  ...
  expect_true(all.equal(calcConfusionValidationTest, calcConfusionValidationControl, check.attributes = FALSE))
})
...
test_that('calcConfusionValidation each = FALSE', {
  ...
  expect_true(all.equal(calcConfusionValidationEachFalseTest, calcConfusionValidationEachFalseControl, check.attributes = FALSE))
})
